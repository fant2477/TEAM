...
public class header_page extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		{
			doclist = View.toListofDocDetail(Integer.valueOf(pg) , 2 , Integer.valueOf(head_id) ,search_input , "Doc_ID");
		}
		else
		{
			doclist = View.toListofDocDetail(Integer.valueOf(pg) , 2 , Integer.valueOf(head_id) );
		}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (pg_go != null) {
			...
			System.out.println(pg_go+" pg was press");
