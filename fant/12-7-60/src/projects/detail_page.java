...
//			response.sendRedirect("UI_Manager");
			...
			PrintWriter out = response.getWriter();
			doc.downloadFile(Integer.valueOf(doc_id), "C:\\Users\\User\\Desktop\\testdownload");
			...
			out.println("<script type=\"text/javascript\">");
			out.println("alert('your file "+doc_id+" was successfully downloaded.')");
			out.println("location='detail_page';");
			out.println("</script>");
			
			System.out.println("go to detail_page again");
