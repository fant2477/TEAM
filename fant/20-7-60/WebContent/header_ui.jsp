                      ...
                      <table class="table table-striped table-bordered" >
                        	...
                        	<c:forEach items="${doclist}" var="doc" varStatus="pstatus">
                              ...
                              <td>${(pstatus.index)+(start_pg)}</td>
                        			...
                        			<td><p><input type="submit" name="bt" value="${doc.getDoc_ID()}" class="link_detail" id = "header_link"></p></td>
                              ...
                              <td align="center"><input type="checkbox" name="file_cb" value="${doc.getDoc_ID()}" ></td>
