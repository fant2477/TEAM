     ...
     <!-- <%-- <div class="w3-row-padding w3-grayscale" style="margin-bottom:128px">
       <div class="w3-half"> --%> -->
         <div class="form-inline">
             <p> Document Name :     <input type = "text" id = "subject" name= "subject" class="form-control form-group" title = "please fill your subject" size = "37" value = "${doc_name}"></p>
             <p> Document code : ${doc_code}</p>
             ...
             <p>Descriptions  :     </br><textarea  id = "descriptions" rows="4" cols="50" name="descriptions" class="form-control form-group" title ="please enter your document descriptions" size="37">${des}</textarea></p>
         <!-- <%-- </div>
       </div> --%> -->
             <!-- <p align = "center"><input type="file" id = "file" name = "file" class="form-control "> -->
