...
public class user_history_page extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		{
			doclist = View.toListofDocHeader(Integer.valueOf(pg),10,current_user.getUser_ID(),search_input,"Doc_header_ID");
		}
		else{
			doclist = View.toListofDocHeader(Integer.valueOf(pg),10,current_user.getUser_ID(),"","Doc_header_ID");
		}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
			...
			if (pg_go != null) {
				...
				System.out.println("go to user_history_page again");
