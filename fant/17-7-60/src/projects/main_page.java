...
public class main_page extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		{
			doclist = View.toListofDocHeader(Integer.valueOf(pg),10,search_input,"Doc_header_ID");
		}
		else{
			doclist = View.toListofDocHeader(Integer.valueOf(pg),10);
		}
		...
		int start_pg = (Integer.valueOf(pg)*10)-(10-1);
