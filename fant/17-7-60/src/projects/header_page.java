...
public class header_page extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		{
			doclist = View.toListofDocDetail(Integer.valueOf(pg) , 5 , Integer.valueOf(head_id) ,search_input , "Doc_ID");
		}
		else
		{
			doclist = View.toListofDocDetail(Integer.valueOf(pg) , 5 , Integer.valueOf(head_id) );
		}
