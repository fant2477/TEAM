...
<link rel="stylesheet" href="./z-test2.css">
            ...
            <div class="container-fluid">
                  ...
                  <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        ...
                        <ul class="nav navbar-nav navbar-right">
                              ...
                              <button id="User_info" class="btn btn-default btn-link" type="button"><i class="fa fa-user-circle-o" ></i></button>
        ...
        <div class="row">
              ...
              <div class="col-xs-2">
                  ...
                  <div class="btn-group-vertical btn-block" role="group" aria-label="..." id="div_top">
                    ...
                    <input type="submit" class="btn btn-default btn-lg bt" name = "bt"  value="Profile" id = "pf"  />
              ...
              <div class="col-xs-3">
                    ...
                    <div class="form-inline">
                          ...
                          <p>Name :          <input type= "text" id="firstname" name="firstname" class="form-inline form-control" title ="please enter your firstname" size="37" value = "${firstname}"/><small id = "small">${firstname_check}</small></p>
                          </div>
                          <div class = "form-group">
                          ...
                          <div class = "form-group">
                          <p>Confirm Password  :     <input type = "password" id = "confirm_password" name = "confirm_password" class="form-inline form-control" title = "please enter your password again" size = "37" value = "${password}"><small id = "small">${confirm_password}</small></p>
                          </div>
                          </br></br>
