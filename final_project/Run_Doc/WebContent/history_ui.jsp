...
<!-- ============================================ end of header tab ============================================ -->
 ...
 <!-- ========================search group======================== -->
                  <div class="input-group">
                      <input type="text" id="search_input" name="search_input" class="form-control" value="${search_input}" placeholder="Search for..." aria-label="Search for...">
                  ...
                  <div class="w3-container">
                      <table class="w3-table-all co">
                        	...
                        	<c:forEach items="${lg}" var="doc" varStatus="pstatus">
                        		<tr>
                        		<%-- <c:set var="pstatus.index" value="${p}"></c:set>
                        		<td><% out.println(p);%></td> --%>

                        		<td class="w3-rgb(255, 102, 102)">${(pstatus.index)+(start_pg)}</td>
