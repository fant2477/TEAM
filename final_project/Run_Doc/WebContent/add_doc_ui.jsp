     ...
     <!-- <%-- <div class="w3-row-padding w3-grayscale" style="margin-bottom:128px">
       <div class="w3-half"> --%> -->
         <div class="form-inline">
             <p>Doc Header  :     <input type = "text" id = "subject" name= "subject" class="form-control form-group" title = "please fill your subject" size = "29.5" value = "${subject}"><small id = "small">${subject_check}</small></p>
